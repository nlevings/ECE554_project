...
wire iocs; //trxn control
wire iorw; //determins if this is a read (1) or write (0)
wire rda; //receive data available 
wire tbr; //tranmit buffer ready
wire [1:0] ioaddr;
wire [7:0] databus;
wire [1:0] br_cfg;
...
// LED[7] : indicator for rst signal 
// LED[6:0] : databus [6:0]
assign LEDR = {~rxd,~txd,~rst, databus[6:0]};
//assign LEDR = {~rxd,~txd,databus};
